        ...
        <div class="row">
            <div class="col-md-8">
                ...
                if (isset($_POST['sub_mit'])) {
                    ...
                    $row = update_banviet($tieude, $ten_hinh, $noidung, $id);
                ...
                ?>
                        <form action="" method="POST" enctype="multipart/form-data">
                            ...
                            <div class="form-group">
                                <h5>Hình bài viết</h5>
                                <input class="form-control" type="file" name="hinh" value="<?= $a['hinh_bai_viet'] ?>">
                            </div>
                            <div class="form-group">
                                <h5>Nội Dung</h5>
                ...
                ?>
                <a name="" id="" class="btn btn-outline-info btn-block" href="<?= $admin ?>/layout.php?baiviet_list" role="button">Trở về danh sách</a>
            </div>
